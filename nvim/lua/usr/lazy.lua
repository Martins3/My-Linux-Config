...

  {
    ...
    config = function()
      require('rimels').setup({
        ...
        cmd = { "/home/martins3/.cargo/bin/rime_ls" },          -- MacOS: ~/.local/bin/rime_ls
        rime_user_dir = "/home/martins3/.local/share/rime-ls",
        shared_data_dir = "/home/martins3/.local/share/fcitx5/rime", -- MacOS: /Library/Input Methods/Squirrel.app/Contents/SharedSupport
