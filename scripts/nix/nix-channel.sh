...
if [[ -f /etc/nixos/configuration.nix ]]; then
	$SUDO nix-channel --add https://mirror.tuna.tsinghua.edu.cn/nix-channels/nixos-25.05 nixos
	$SUDO nix-channel --add https://mirrors.tuna.tsinghua.edu.cn/nix-channels/nixos-unstable/ nixos-unstable
fi
$SUDO nix-channel --add https://mirror.tuna.tsinghua.edu.cn/nix-channels/nixos-25.05 nixpkgs
